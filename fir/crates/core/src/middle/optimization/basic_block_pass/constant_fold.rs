use crate::middle::optimization::basic_block_pass::BasicBlockPass;
use rustc_hash::FxHashMap;

use crate::middle::cfg::{BasicBlockId, BranchTerm, TerminatorKind};
use crate::middle::{FunctionId, Value};
use crate::middle::instruction::{Const, ICmpCond, InstrKind, Op, OpInstr};
...
mod tests {
    ...
    use crate::middle::instruction::{Const, InstrKind, Op, OpInstr};
    use crate::middle::optimization::{Pipeline, PipelineConfig};
